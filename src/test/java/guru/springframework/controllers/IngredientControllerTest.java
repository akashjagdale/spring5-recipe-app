...
public class IngredientControllerTest {
	...
	public void testUpdateIngredientForm() throws Exception {
		...
		// then
		mockMvc.perform(get("/recipe/1/ingredients/2/update")).andExpect(status().isOk())
				.andExpect(view().name("recipe/ingredient/ingredientform"))
				.andExpect(model().attributeExists("ingredient")).andExpect(model().attributeExists("uomList"));
	}
	...
	public void testSaveOrUpdate() throws Exception {
		...
		// then
		mockMvc.perform(post("/recipe/2/ingredient/save").contentType(MediaType.APPLICATION_FORM_URLENCODED)
